...
namespace JsPlc.Ssc.Link.Portal
{
	public class LinkServiceFacade : IDisposable, ILinkServiceFacade
	{
		...
		{
			return _cacheService.GetOrSet("IsManagerByEmail" + email, DateTime.Now.AddMinutes(10), () =>
			{
		...
		{
			return _cacheService.GetOrSet("GetColleague" + ColleagueId, DateTime.Now.AddMinutes(10), () =>
			{
