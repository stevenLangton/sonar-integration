    ...
    public class StubRepositoryInitializer : DropCreateDatabaseIfModelChanges<StubRepositoryContext>
    {
        protected override void Seed(StubRepositoryContext context)
        {
            ...
            var employees=new List<StubColleague>{
                ...
                new StubColleague{Id=1, FirstName="Luan", LastName="Au", ColleagueId="E001", ManagerId="E0009", 
                    EmailAddress="Luan.Au@linktool.onmicrosoft.com"},
                new StubColleague{Id=2, FirstName="Parveen", LastName="Kumar", ColleagueId="E002", ManagerId="E0009", 
                ...
                new StubColleague{Id=5, FirstName="Laxmi", LastName="Nagaraja", ColleagueId="E005", ManagerId="E0009", 
                    EmailAddress="Lakshmi.Nagaraja@linktool.onmicrosoft.com"},
                new StubColleague{Id=6, FirstName="Tim", LastName="Morrison", ColleagueId="E006", ManagerId="E0009", 
                    EmailAddress="Tim.Morrison@linktool.onmicrosoft.com"},
                new StubColleague{Id=7, FirstName="Chris", LastName="Atkin", ColleagueId="E007", ManagerId="E0009", 
