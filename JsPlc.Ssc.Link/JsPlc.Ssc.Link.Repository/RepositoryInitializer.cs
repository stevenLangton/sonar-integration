        ...
        protected override void Seed(RepositoryContext context)
        {
         var periods = new List<Period>{
            ...
            var employees=new List<Employee>{
                new Employee{Id=1, FirstName="Vasundhara", LastName="Chimakurthi", EmployeeId= "E001", ManagerId="E0010", EmailAddress="Vasundhara.B@sainsburys.co.uk"},
                new Employee{Id=2, FirstName="Laxmi", LastName="Nagaraja", EmployeeId="E002", ManagerId="E009", EmailAddress="Laxmi.N@sainsburys.co.uk"},
                new Employee{Id=3, FirstName="Tim", LastName="Morrison", EmployeeId="E003", ManagerId="E009", EmailAddress="Tim.M@sainsburys.co.uk"},
                new Employee{Id=4, FirstName="Chris", LastName="Atkin", EmployeeId="E004", ManagerId="E009", EmailAddress="Chris.A@sainsburys.co.uk"},
                new Employee{Id=5, FirstName="Luan", LastName="Au", EmployeeId="E005", ManagerId="E0010", EmailAddress="Luan.A@sainsburys.co.uk"},
                new Employee{Id=6, FirstName="Praveen", LastName="Kumar", EmployeeId="E006", ManagerId="E0010", EmailAddress="Praveen.K@sainsburys.co.uk"},
                new Employee{Id=7, FirstName="Steven", LastName="A", EmployeeId="E007", ManagerId="E0010", EmailAddress="Steven.A@sainsburys.co.uk"},
                new Employee{Id=8, FirstName="Anis", LastName="Batilwala", EmployeeId="E008", ManagerId="E009", EmailAddress="Anis.B@sainsburys.co.uk"},
                new Employee{Id=9, FirstName="Mohammed", LastName="Tahir", EmployeeId="E009", ManagerId=string.Empty, EmailAddress="Mohammed.T@sainsburys.co.uk"},
                new Employee{Id=10, FirstName="Sandip", LastName="Vaidya", EmployeeId="E0010", ManagerId=string.Empty, EmailAddress="Sandip.V@sainsburys.co.uk"}
            };
            ...
            performance.ForEach(c=>context.Performance.Add(c));
            context.SaveChanges();

            var answers = new List<Answer>{
                new Answer{Id=1, ManagerComments="Hard Worker", ColleagueComments="I'm a hard worker with the experience to get things done efficiently.", QuestionId=1, EmployeeId=1},
                new Answer{Id=2, ManagerComments="Studying", ColleagueComments="By researching and reading books", QuestionId=1, EmployeeId=1},
                new Answer{Id=3, ManagerComments="Training", ColleagueComments="By getting trainning in specific areas", QuestionId=1, EmployeeId=1},
                new Answer{Id=4, ManagerComments="Commitment ", ColleagueComments="More commitment towards work", QuestionId=1, EmployeeId=1},
                new Answer{Id=5, ManagerComments="Approach", ColleagueComments="BY changing the approach", QuestionId=1, EmployeeId=1},
                new Answer{Id=6, ManagerComments="More Organizational skills", ColleagueComments="I can contribute my organizational skills and my ability to work well in a group.", QuestionId=1, EmployeeId=10},
                new Answer{Id=7, ManagerComments="Studying", ColleagueComments="By researching and reading books", QuestionId=1, EmployeeId=10},
                new Answer{Id=8, ManagerComments="Training", ColleagueComments="By getting trainning in specific areas", QuestionId=1, EmployeeId=10},
                new Answer{Id=9, ManagerComments="Commitment ", ColleagueComments="More commitment towards work", QuestionId=1, EmployeeId=10},
                new Answer{Id=10, ManagerComments="Approach", ColleagueComments="BY changing the approach", QuestionId=1, EmployeeId=10}
             };
